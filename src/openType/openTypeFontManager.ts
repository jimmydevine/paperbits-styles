...
export class FontManager {
    ...
    // private async getFont(styles: ThemeContract, glyphs: Object): Promise<void> {
    ...
    public async removeGlyph(styles: ThemeContract, unicode: number): Promise<void> {
        ...
        // const iconToDelete = Object.values(styles.icons).find(x => x.unicode === unicode);

        // if (iconToDelete) {
        //     Objects.setValue(iconToDelete.key, styles, null);
        // }
    }

    public async addFontFaceToFamily(): Promise<void> {
        // TODO
    }
}